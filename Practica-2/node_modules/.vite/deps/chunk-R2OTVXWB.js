...
// node_modules/@vaadin/hilla-react-signals/node_modules/@preact/signals-react/runtime/dist/runtime.module.js
...
function $(n2) {
  ...
  if (null == t.current) if ("undefined" == typeof window) t.current = S;
  else t.current = function(n3) {
    var t2, r3, e2, o2, u3 = 0, f2 = E(function() {
      r3 = this;
    });
    r3.c = function() {
      u3 = u3 + 1 | 0;
    ...
    return (t2 = { o: n3, effect: r3, subscribe: function(n4) {
      o2 = n4;
      return function() {
        u3 = u3 + 1 | 0;
        o2 = void 0;
      ...
      if (null != p) {
        var n4 = p.o, t3 = this.o;
        if (0 == n4 && 0 == t3 || 0 == n4 && 1 == t3) {
          p.f();
          e2 = b(void 0, this);
        } else if (1 == n4 && 0 == t3 || 2 == n4 && 0 == t3) ;
        else e2 = b(p, this);
...
Object.defineProperties(u.prototype, { $$typeof: { configurable: true, value: v }, type: { configurable: true, value: function(n2) {
  var t = n2.data, r2 = $(1);
  try {
    return t.value;
  } finally {
...
function useComputed(n2) {
  var t = (0, import_react.useRef)(n2);
  t.current = n2;
  return (0, import_react.useMemo)(function() {
    return w(function() {
      return t.current();
  ...
  constructor(value, config, id) {
    ...
    this.subscribe((v2) => {
      if (!__privateGet(this, _paused)) {
        ...
        this[$update](createSetStateEvent(v2, signalId, config.parentClientSignalId));
      }
    });
...
//# sourceMappingURL=chunk-R2OTVXWB.js.map
